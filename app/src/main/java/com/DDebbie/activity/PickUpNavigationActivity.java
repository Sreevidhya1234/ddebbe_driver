...
public class PickUpNavigationActivity extends AppCompatActivity  implements GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    public static final String TAG1 = PickUpNavigationActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pick_up_navigation);
    ...
    private String getDirectionsUrl(LatLng origin,LatLng dest){
      ...
      //  String url = "https://maps.googleapis.com/maps/api/directions/"+output+"?"+parameters;
        String url = "https://maps.google.com/?saddr="+str_origin+"&daddr="+str_dest+"&views=transit&directionsmode=driving";
