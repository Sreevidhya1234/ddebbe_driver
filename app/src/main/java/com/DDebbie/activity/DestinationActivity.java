...
public class DestinationActivity extends AppCompatActivity implements GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private void init() {
        ...
        slideButton = (SlideButton) findViewById(R.id.sliderStartTrip);
