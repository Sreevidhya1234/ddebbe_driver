...
public class PickUpInformationActivity extends AppCompatActivity  implements GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    public static final String TAG1 = PickUpInformationActivity.class.getSimpleName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pick_up_information);
        ...
        fragmentTransaction.replace(R.id.container, pickupInformationFragment, pickupInformationFragment.getClass().getName());
        fragmentTransaction.addToBackStack(pickupInformationFragment.getClass().getName());
